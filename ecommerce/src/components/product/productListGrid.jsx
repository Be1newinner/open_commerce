  ...
  return (
    <div className="flex flex-wrap max-w-5xl max-md:w-full mb-10 mx-auto gap-7 ">
      {products?.map((product) => (
        <Link href={`/product/${product.sku}`} key={product._id}>
          <section className="group hover:shadow-lg hover:shadow-gray-400 duration-500 items-center gap-4 border-solid border-2 border-gray-300 rounded-xl w-[300px] max-md:w-full max-sm:w-full p-2 ">
            <div className="w-full h-[300px] p-2 overflow-hidden justify-center items-center flex group-hover:scale-110 duration-500 ease-in-out">
              <Image src={product.image} alt="" width={500} height={500} className="group-hover:bg-slate-500 rounded-lg" />
            ...
            <div className="p-2 border-t-2 top-1 border-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span className="pl-2 pt-0.5">{product.rating} rating</span>
              </div>
